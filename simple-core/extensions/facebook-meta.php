<?php 
/**
 * Facebook Meta Fields - Adds Facebook open graph meta fields to the theme header.
 *
 * Facebook Meta Fields assists with adding Facebook compatibility to your site.
 *
