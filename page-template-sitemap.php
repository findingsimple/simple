				...
				<?php while ( have_posts() ) : the_post(); ?>
					...
					<div id="post-<?php the_ID(); ?>" class="<?php hybrid_entry_class(); ?>">
						...
						<div class="entry-content">
							...
							<h2><?php _e( 'Feeds', hybrid_get_parent_textdomain() ); ?></h2>
		
							<ul class="xoxo feeds">
								<li><a href="<?php bloginfo( 'rdf_url' ); ?>" title="<?php esc_attr_e( 'RDF/RSS 1.0 feed', 'hybrid' ); ?>"><?php _e( '<acronym title="Resource Description Framework">RDF</acronym> <acronym title="Really Simple Syndication">RSS</acronym> 1.0 feed', hybrid_get_parent_textdomain() ); ?></a></li>
								<li><a href="<?php bloginfo( 'rss_url' ); ?>" title="<?php esc_attr_e( 'RSS 0.92 feed', 'hybrid' ); ?>"><?php _e( '<acronym title="Really Simple Syndication">RSS</acronym> 0.92 feed', hybrid_get_parent_textdomain() ); ?></a></li>
								<li><a href="<?php bloginfo( 'rss2_url' ); ?>" title="<?php esc_attr_e( 'RSS 2.0 feed', 'hybrid' ); ?>"><?php _e( '<acronym title="Really Simple Syndication">RSS</acronym> 2.0 feed', hybrid_get_parent_textdomain() ); ?></a></li>
								<li><a href="<?php bloginfo( 'atom_url' ); ?>" title="<?php esc_attr_e( 'Atom feed', 'hybrid' ); ?>"><?php _e( 'Atom feed', hybrid_get_parent_textdomain() ); ?></a></li>
								<li><a href="<?php bloginfo( 'comments_rss2_url' ); ?>" title="<?php esc_attr_e( 'Comments RSS 2.0 feed', 'hybrid' ); ?>"><?php _e( 'Comments <acronym title="Really Simple Syndication">RSS</acronym> 2.0 feed', hybrid_get_parent_textdomain() ); ?></a></li>
							</ul><!-- .xoxo .feeds -->
		
							<h2><?php _e( 'Pages', hybrid_get_parent_textdomain() ); ?></h2>
		
							<ul class="xoxo pages">
								<?php wp_list_pages( array( 'title_li' => false ) ); ?>
							</ul><!-- .xoxo .pages -->
		
							<h2><?php _e( 'Category Archives', hybrid_get_parent_textdomain() ); ?></h2>
							...
							<h2><?php _e( 'Author Archives', hybrid_get_parent_textdomain() ); ?></h2>
		
							<ul class="xoxo author-archives">
								<?php wp_list_authors( array( 'exclude_admin' => false, 'show_fullname' => true, 'feed' => __( 'RSS', hybrid_get_parent_textdomain() ), 'optioncount' => true, 'title_li' => false ) ); ?>
							</ul><!-- .xoxo .author-archives -->
		
							<h2><?php _e( 'Yearly Archives', hybrid_get_parent_textdomain() ); ?></h2>
		
							<ul class="xoxo yearly-archives">
								<?php wp_get_archives( array( 'type' => 'yearly', 'show_post_count' => true ) ); ?>
							</ul><!-- .xoxo .yearly-archives -->
		
							<h2><?php _e( 'Monthly Archives', hybrid_get_parent_textdomain() ); ?></h2>
		
							<ul class="xoxo monthly-archives">
								<?php wp_get_archives( array( 'type' => 'monthly', 'show_post_count' => true ) ); ?>
							</ul><!-- .xoxo .monthly-archives -->
		
							<h2><?php _e( 'Weekly Archives', hybrid_get_parent_textdomain() ); ?></h2>
		
							<ul class="xoxo weekly-archives">
								<?php wp_get_archives( array( 'type' => 'weekly', 'show_post_count' => true ) ); ?>
							</ul><!-- .xoxo .weekly-archives -->
		
							<h2><?php _e( 'Daily Archives', hybrid_get_parent_textdomain() ); ?></h2>
		
							<ul class="xoxo daily-archives">
								<?php wp_get_archives( array( 'type' => 'daily', 'show_post_count' => true ) ); ?>
							</ul><!-- .xoxo .daily-archives -->
		
							<h2><?php _e( 'Tag Archives', hybrid_get_parent_textdomain() ); ?></h2>
		
							<p class="tag-cloud">
								<?php wp_tag_cloud( array( 'number' => 0 ) ); ?>
							</p><!-- .tag-cloud -->
		
							<h2><?php _e( 'Blog Posts', hybrid_get_parent_textdomain() ); ?></h2>
