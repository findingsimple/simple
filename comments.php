	...
	<div class="comments-wrap">
		...
		<div id="comments">
			...
			<?php if ( have_comments() ) : ?>
				...
				<h3 id="comments-number" class="comments-header"><?php comments_number( __( 'No Comments', hybrid_get_parent_textdomain() ), __( 'One Comment', hybrid_get_parent_textdomain() ), __( '% Comments', hybrid_get_parent_textdomain() ) ); ?></h3>
